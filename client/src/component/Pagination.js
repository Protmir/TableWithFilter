export const Pagination = ({ activePage, count, recordsPerPage, totalPages, setActivePage }) => {
    const beginning = activePage === 1 ? 1 : recordsPerPage * (activePage - 1) + 1
    const end = activePage === totalPages ? count : beginning + recordsPerPage - 1
